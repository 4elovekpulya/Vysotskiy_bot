...
RESULTS = {
    'a': "Вы — Георгий Клочков (фильм «Вертикаль»). Как альпинист Клочков, вы готовы рисковать всем ради свободы и высоты. Ваш дух приключений вдохновляет окружающих, даже если путь к цели полон опасностей. 16 марта 18 часов, ТЦКТ Сиреневый 1, спектакль-концерт «Интервью с Высоцким». По промокоду «GEROY» мы дарим скидку 10%, Купить билеты: https://clck.ru/3GCMAP ",
    'b': "Вы — Глеб Жеглов (фильм «Место встречи изменить нельзя»). Вы лидер и борец за справедливость, который знает, что «вор должен сидеть в тюрьме». У вас сильный характер, а ваш авторитет невозможно оспорить. 16 марта 18 часов, ТЦКТ Сиреневый 1, спектакль-концерт «Интервью с Высоцким». По промокоду «GEROY» мы дарим скидку 10%, Купить билеты: https://clck.ru/3GCMAP ",
    'c': "Вы — Дон Гуан (фильм «Маленькие трагедии»). Как бунтарь и философ, вы не боитесь бросить вызов обществу, но ваши действия всегда имеют глубокий смысл. Ваш внутренний мир — это тайна, которая манит других. 16 марта 18 часов, ТЦКТ Сиреневый 1, спектакль-концерт «Интервью с Высоцким». По промокоду «GEROY» мы дарим скидку 10%, Купить билеты: https://clck.ru/3GCMAP ",
    'd': "Вы — Хлопуша (спектакль «Пугачёв»). Вы творческий и свободолюбивый человек, который не терпит ограничений. Ваша сила в том, чтобы находить нестандартные решения и вдохновлять других своим примером. 16 марта 18 часов, ТЦКТ Сиреневый 1, спектакль-концерт «Интервью с Высоцким». По промокоду «GEROY» мы дарим скидку 10%, Купить билеты: https://clck.ru/3GCMAP "
}

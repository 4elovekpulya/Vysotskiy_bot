...
RESULTS = {
    'a': "Вы — Георгий Клочков (фильм «Вертикаль»). Как альпинист Клочков, вы готовы рисковать всем ради свободы и высоты. Ваш дух приключений вдохновляет окружающих, даже если путь к цели полон опасностей. 25 января 18 часов, ДК МИР, спектакль-концер «Интервью с Высоцким». Билеты для Вас https://clck.ru/3FiYWp",
    'b': "Вы — Глеб Жеглов (фильм «Место встречи изменить нельзя»). Вы лидер и борец за справедливость, который знает, что «вор должен сидеть в тюрьме». У вас сильный характер, а ваш авторитет невозможно оспорить. 25 января 18 часов, ДК МИР, спектакль-концер «Интервью с Высоцким». Билеты для Вас https://clck.ru/3FiYWp",
    'c': "Вы — Дон Гуан (фильм «Маленькие трагедии»). Как бунтарь и философ, вы не боитесь бросить вызов обществу, но ваши действия всегда имеют глубокий смысл. Ваш внутренний мир — это тайна, которая манит других. 25 января 18 часов, ДК МИР, спектакль-концер «Интервью с Высоцким». Билеты для Вас https://clck.ru/3FiYWp",
    'd': "Вы — Хлопуша (спектакль «Пугачёв»). Вы творческий и свободолюбивый человек, который не терпит ограничений. Ваша сила в том, чтобы находить нестандартные решения и вдохновлять других своим примером. 25 января 18 часов, ДК МИР, спектакль-концер «Интервью с Высоцким». Билеты для Вас https://clck.ru/3FiYWp"
}
